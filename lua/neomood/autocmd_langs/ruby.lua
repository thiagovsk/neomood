...
require("neomood.autocmd_langs.base").create_au_for_lang("ruby", function(buf)
  local n = utils.n_buf
  local v = utils.v_buf
  ...
  n("<leader>mC", require("neomood.lang_helpers.ruby").search_class_name, "Search Class Name", buf.buf)
  n("<leader>md", require("neomood.lang_helpers.ruby").comment_rubocop, "Comment Rubocop", buf.buf)
